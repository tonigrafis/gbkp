...
<section id="news" style="display:none;">
	<div class="col-lg-9 col-md-8 col-sm-12 pull-left">
		<p class="p-arikel">Berikut adalah daftar runggun, silahkan <i>klik</i> ditombol Baca Selengkapnya untuk melihat daftar runggun.</p>
	</div><div class="col-lg-3 col-md-4 col-sm-6 pull-right">
		<input type="text" id="cari" style="float: right;display: none;" class="form-control" placeholder="Cari / Ketik Runggun ...." autocomplete="off" onpaste="false"></input>
	</div>
...
$(document).ready(function(){
	let request_lt = $.ajax({
		...
		data : {tipe_ajax:btoa(0),xid:"<?=$xid?>",id_page:8},
		dataType: 'json',
	});
