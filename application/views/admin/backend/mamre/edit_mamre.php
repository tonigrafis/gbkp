<div id="main-content" >  
	<form method="post">
		<div class="card" style="margin-bottom: 0px;"> 
			<div class="body"> 
                <h5>Ubah Data Mamre</h5>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text" >Judul Mamre</span>
                    </div>
                    ...
                    <div class="input-group-append">
                        <button class="btn btn-success" id="simpan" type="button">Simpan Mamre</button>
                    </div>
                </div>
...
$(document).ready(function(){
    $("#simpan").click(function(){
        ...
        if(judul=="") {
            alert('Silakan isi judul Mamre, terlebih dahulu.');
        }else if(isi==""){
            alert('Silakan isi keterangan dan gambar Mamre, terlebih dahulu.');
        }else{
			$.ajax({
                type : "POST",
                url  : "<?= base_url('admin/ubah_post_mamre')?>",
                data : {judul:judul,isi:isi,id:id},
                beforeSend: function(){
					$('#popup_loading').show();
            	}, success: function(){
					window.location.href = "<?= base_url('admin/mamre')?>";
                    console.log('berhasil diubah');
                }, error:function(){
					alert('Gagal mengubah data Mamre, silahkan ulangi kembali.');
					$('#popup_loading').hide();
                }
            });
		}  
