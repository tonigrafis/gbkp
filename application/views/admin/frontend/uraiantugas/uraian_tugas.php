					...
					<table class="table table-bordered table-custom " id="datatable">
						<thead>
							<tr>
								<th>Aksi</th> 
								<th>No.</th> 
								<th>Judul Uraian Tugas</th> 
								<th>Isi Uraian Tugas</th> 
							</tr>
						</thead>
						<tbody>
							...
							<tr>
								<td>  
									<a class="btn btn-sm btn-info" href="<?= base_url()?>admin/edit_uraian_tugas/<?=encrypt_url($val->id_posting);?>"><i class="fa fa-pencil"></i> Ubah</a> 
								</td>
								<td><?=$no++;?></td>
