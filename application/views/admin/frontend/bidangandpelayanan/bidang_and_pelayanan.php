					...
					<table class="table table-bordered table-custom " id="datatable">
						<thead>
							<tr>
								<th>Aksi</th> 
								<th>No.</th> 
								<th>Judul Bidang & Departemen</th> 
								<th>Isi Bidang & Departemen</th> 
							</tr>
						</thead>
						<tbody>
							...
							<tr>
								<td>  
									<a class="btn btn-sm btn-info" href="<?= base_url()?>admin/edit_bidang_and_pelayanan/<?=encrypt_url($val->id_posting);?>"><i class="fa fa-pencil"></i> Ubah</a> 
								</td>
								<td><?=$no++;?></td>
